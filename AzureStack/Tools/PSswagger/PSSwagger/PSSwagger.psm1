...
function New-PSSwaggerModule
{
    ...
    $frameworksToCheckDependencies = @('net45')
...
function ConvertTo-CsharpCode
{
    ...
    if (-not (get-command -name autorest))
    {
    ...
    try {
        ...
        $dependencies = Get-PSSwaggerExternalDependencies -Azure:$codeCreatedByAzureGenerator -Framework 'net45'
